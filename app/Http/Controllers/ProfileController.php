...
class ProfileController extends Controller
{
    ...
    {
        return Inertia::render('Administradores/Profile/Edit', [
    ...
    public function editCliente(Request $request): Response
    {
        return Inertia::render('Clientes/Profile/Edit', [
            'mustVerifyEmail' => $request->user() instanceof MustVerifyEmail,
            'status' => session('status'),
        ]);
    }
    ...
    public function updateCliente(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('profile.cliente.edit');
    }
